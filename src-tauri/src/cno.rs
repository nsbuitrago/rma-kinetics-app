...
pub struct CnoArgs {
    dose: f64,
    t0: f64,
    cno_absorption_rate: f64,
    cno_elimination_rate: f64,
    cno_reverse_metabolism_rate: f64,
    clz_metabolism_rate: f64,
    cno_brain_transport_rate: f64,
    cno_plasma_transport_rate: f64,
    clz_brain_transport_rate: f64,
    clz_plasma_transport_rate: f64,
    clz_elimination_rate: f64,
    cno_plasma_vd: f64,
    cno_brain_vd: f64,
    clz_plasma_vd: f64,
    clz_brain_vd: f64,
